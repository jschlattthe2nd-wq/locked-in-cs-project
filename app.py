...
def initdatabase():
    try:
        ...
        if cursor.fetchone()[0] == 0:
            team_data = [
                ('2001 Los Angeles Lakers', 108.4, 104.8), 
                ('2001 Philadelphia 76ers', 101.8, 98.9),
                ('2002 Los Angeles Lakers', 109.4, 101.7), 
                ('2002 New Jersey Nets', 101.1, 99.5),
                ('2003 San Antonio Spurs', 105.6, 99.7), 
                ('2003 New Jersey Nets', 100.0, 96.0),
                ('2004 Detroit Pistons', 102.0, 95.4), 
                ('2004 Los Angeles Lakers', 105.5, 103.2),
                ('2005 San Antonio Spurs', 107.5, 98.8), 
                ('2005 Detroit Pistons', 103.9, 98.1),
                ('2006 Miami Heat', 108.7, 104.3), 
                ('2006 Dallas Mavericks', 111.8, 105.0),
                ('2007 San Antonio Spurs', 109.2, 99.9), 
                ('2007 Cleveland Cavaliers', 103.8, 101.3),
                ('2008 Boston Celtics', 110.2, 98.9), 
                ('2008 Los Angeles Lakers', 113.0, 105.5),
                ('2009 Los Angeles Lakers', 112.8, 104.7), 
                ('2009 Orlando Magic', 108.6, 101.9),
                ('2010 Los Angeles Lakers', 108.8, 103.7), 
                ('2010 Boston Celtics', 107.7, 103.8),
                ('2011 Dallas Mavericks', 109.7, 105.0), 
                ('2011 Miami Heat', 111.7, 103.5),
                ('2012 Miami Heat', 108.5, 100.2), 
                ('2012 Oklahoma City Thunder', 109.8, 103.2),
                ('2013 Miami Heat', 112.3, 103.1),
                ('2013 San Antonio Spurs', 108.1, 101.6),
                ('2014 San Antonio Spurs', 110.5, 102.4),
                ('2014 Miami Heat', 109.0, 105.8),
                ('2015 Golden State Warriors', 111.6, 101.4), 
                ('2015 Cleveland Cavaliers', 109.8, 106.3),
                ('2016 Cleveland Cavaliers', 110.9, 104.2), 
                ('2016 Golden State Warriors', 114.5, 103.8),
                ('2017 Golden State Warriors', 115.6, 102.5), 
                ('2017 Cleveland Cavaliers', 113.6, 108.0),
                ('2018 Golden State Warriors', 113.6, 107.7), 
                ('2018 Cleveland Cavaliers', 111.1, 110.6),
                ('2019 Toronto Raptors', 113.1, 107.1), 
                ('2019 Golden State Warriors', 115.9, 109.0),
                ('2020 Los Angeles Lakers', 112.0, 105.6), 
                ('2020 Miami Heat', 112.5, 109.8),
                ('2021 Milwaukee Bucks', 117.2, 111.0), 
                ('2021 Phoenix Suns', 117.2, 111.3),
                ('2022 Golden State Warriors', 112.5, 106.6), 
                ('2022 Boston Celtics', 114.4, 106.9),
                ('2023 Denver Nuggets', 117.6, 113.5), 
                ('2023 Miami Heat', 113.0, 112.8),
                ('2024 Boston Celtics', 122.2, 109.2), 
                ('2024 Dallas Mavericks', 117.0, 114.9),
                ('2025 Oklahoma City Thunder', 118.5, 108.2), 
                ('2025 Indiana Pacers', 119.8, 115.1),
                ('2026 Boston Celtics', 121.5, 110.1), 
                ('2026 Oklahoma City Thunder', 119.2, 108.7)
            ]
